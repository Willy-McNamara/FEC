...
const ReviewForm = ({ name, id, ch_data }) => {
  ...
  //TODO:additional submit button behavior
...
//TODO: factor this out into a seperate file
  }
  ...
  return (
    <div>
      ...
      <form>
        ...
        <input type="text" id="name" name="name" placeholder="Example: jackson11!" />
        ...
        <span>For authentication reasons, you will not be emailed” will appear.</span>
